...
import striptags from "striptags"; // Import the strip-html-tags library
...
const CreatePost = () => {
  ...
  const [description, setDescription] = useState(""); // To store the HTML content
  ...
  const formSubmitHandler = (e) => {
    ...
    const sanitizedContent = striptags(description);

    const formData = new FormData();
    formData.append("image", file);
    formData.append("title", title);
    formData.append("description", sanitizedContent); // Use sanitized content
